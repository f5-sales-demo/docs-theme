...
Fügen Sie eine `icon`-Eigenschaft mit der Syntax `prefix:name` hinzu. Alle acht Symbolpakete werden unterstützt — siehe die Dokumentation der [Symbolpakete](https://f5-sales-demo.github.io/docs-icons/) für den vollständigen Katalog.
