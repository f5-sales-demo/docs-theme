...
أضف خاصية `icon` باستخدام صيغة `prefix:name`. جميع حزم الأيقونات الثماني مدعومة — راجع توثيق [حزم الأيقونات](https://f5-sales-demo.github.io/docs-icons/) للاطلاع على الفهرس الكامل.
