...
Agregue una propiedad `icon` usando la sintaxis `prefijo:nombre`. Los ocho paquetes de íconos son compatibles — consulte la documentación de [Paquetes de iconos](https://f5-sales-demo.github.io/docs-icons/) para el catálogo completo.
