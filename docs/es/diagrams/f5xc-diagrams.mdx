...
description: >-
  Diagramas de casos de uso de F5 Distributed Cloud para WAAP, defensa bot,
  redes multinube, DDoS, DNS, seguridad de API y observabilidad usando iconos
  f5-brand.
sidebar:
  order: 22
i18n:
...
### Pipeline de inspección WAAP de múltiples capas

Pipeline de inspección WAAP de múltiples capas con firewall, protección de código de aplicación y defensa bot antes de llegar a la aplicación.
...
### Arquitectura de seguridad en el borde

Arquitectura de seguridad en el borde con WAF, verificación de escudo y grupos de protección de aplicaciones a través de orígenes en la nube.
...
Pipeline de validación de solicitudes de API con firewall, limitación de velocidad y validación de esquema antes de llegar a los endpoints de API.
...
Detección de bots en múltiples etapas con desafío JavaScript, toma de huellas digitales del dispositivo, análisis de comportamiento y motor de decisiones.
...
### Capas de defensa bot

Arquitectura de defensa bot en capas con inteligencia de credenciales, detección de bots y análisis de postura del dispositivo.
...
Pipeline de defensa del lado del cliente con verificación de postura del dispositivo, detección de bots en portátiles y protección contra Magecart.
...
### Conexión de aplicaciones multinube

Conectividad de aplicaciones multinube a través de AWS, Azure y GCP con una capa de distribución de aplicaciones centralizada.
...
Conexión de red multinube con topología de malla de sitios y puerta de enlace de tránsito que vincula regiones en la nube.
...
Distribución de aplicaciones multinube de extremo a extremo con balanceo de carga global, seguridad y cargas de trabajo distribuidas.
...
## DDoS y servicios en el borde

### Arquitectura de limpieza DDoS

Centro de limpieza DDoS con protección en la capa de red, limpieza de sitios y distribución de tráfico limpio al origen.
...
Flujo de tráfico de ataque que muestra la absorción y mitigación de DDoS volumétrico en el borde antes de llegar al origen.
...
### Protección en capas: CDN + DDoS + WAF

Protección en el borde en capas que combina caché CDN, mitigación DDoS e inspección WAF en un pipeline unificado.
...
### GSLB basado en DNS con monitoreo de salud

Balanceo de carga global de servidores basado en DNS con monitoreo de salud a través de endpoints multinube.
...
### Arquitectura de gestión DNS

Infraestructura de gestión DNS con balanceo de carga DNS y protección DNS de escudo a través de regiones en la nube.
...
Balanceo de carga DNS inteligente con integración de DNS en la nube, enrutamiento por rendimiento y conmutación por error automática.
...
## Seguridad de API y descubrimiento

### Pipeline de descubrimiento de APIs ocultas

Pipeline de descubrimiento de APIs ocultas que detecta APIs desconocidas mediante análisis de tráfico y gestión de inventario.
...
### Arquitectura de gateway de API

Gateway de API con autenticación, limitación de velocidad y validación de seguridad que protege los servicios de API del backend.
...
Pipeline del ciclo de vida de API desde el descubrimiento de APIs ocultas, pasando por la catalogación del inventario, hasta la protección activa.
...
### Aplicaciones distribuidas con NGINX One

Plataforma de aplicaciones distribuidas con gestión de NGINX One, cargas de trabajo Kubernetes y control centralizado.
...
Pipeline de observabilidad que recopila métricas de aplicaciones y produce información, alertas y paneles de control.
...
Vista completa de la plataforma F5 que conecta seguridad, redes y distribución de aplicaciones bajo un servicio unificado.
