...
Aggiungere una prop `icon` utilizzando la sintassi `prefisso:nome`. Tutti e otto i pacchetti di icone sono supportati — consultare la documentazione dei [Pacchetti di icone](https://f5-sales-demo.github.io/docs-icons/) per il catalogo completo.
