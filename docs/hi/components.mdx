...
`prefix:name` सिंटैक्स का उपयोग करके `icon` prop जोड़ें। सभी आठ आइकन पैक समर्थित हैं — पूर्ण कैटलॉग के लिए [आइकन पैकेज](https://f5-sales-demo.github.io/docs-icons/) दस्तावेज़ीकरण देखें।
