...
This page describes how content repositories consume the `@f5-sales-demo/docs-theme` npm package to produce fully branded documentation sites.
...
4. **Astro build** — Astro reads the config which calls `createF5xcDocsConfig()`. The factory resolves all theme assets through npm package specifiers (e.g., `@f5-sales-demo/docs-theme/styles/custom.css`)
...
1. A change is merged to `main` in `@f5-sales-demo/docs-theme`
