...
Add an `icon` prop using `prefix:name` syntax. All eight icon packs are supported — see the [Icon Packages](https://f5-sales-demo.github.io/docs-icons/) documentation for the full catalog.
