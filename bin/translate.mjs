...
async function main() {
  ...
  const { f5xcDefaultLocales } = await import(
    '@f5xc-salesdemos/docs-theme/src/i18n/locales.ts'
  );
  const { translateFile } = await import(
    '@f5xc-salesdemos/docs-theme/src/i18n/translator.ts'
  );
